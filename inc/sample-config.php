<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'compiler' => 'true',
                'subtitle' => __( 'Upload logotype', 'redux-framework-demo' ),
            ),

            array(
                'id'       => 'phone_number',
                'type'     => 'text',
                'title'    => __( 'Write Phone', 'redux-framework-demo' ),
            ),
            array(
                'id'       => 'email',
                'type'     => 'text',
                'title'    => __( 'Write Email', 'redux-framework-demo' ),
            ),
        )
    ) );

    Redux::setSection( $opt_name, array(
        'title'            => __( 'Portolio', 'redux-framework-demo' ),
        'id'               => 'portfolio',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'You can customize your portfolio card appearance', 'redux-framework-demo' ),
        'fields'           => array(
            array(
                'id'       => 'time_icon',
                'type'     => 'media',
            ...
            array(
                ...
                'title'    => __( 'Media w/ URL', 'redux-framework-demo' ),
                'compiler' => 'true',
                'subtitle' => __( 'Upload task icon', 'redux-framework-demo' ),
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'opt-typography-title-all',
                'type'     => 'typography',
                'title'    => __( 'Title common style', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify the body font properties.', 'redux-framework-demo' ),
                'google'   => true,
            ...
            array(
                'id'       => 'opt-typography-title-h1',
                'type'     => 'typography',
                'title'    => __( 'Title H1 style', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify the body font properties.', 'redux-framework-demo' ),
                'google'   => true,
                'output' => array('h1'),
                'default'  => array(
            ...
            array(
                'id'       => 'opt-typography-title-h2',
                'type'     => 'typography',
                'title'    => __( 'Title H2 style', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify the body font properties.', 'redux-framework-demo' ),
                'google'   => true,
                'output' => array('h2'),
                'default'  => array(
            ...
            array(
                'id'       => 'opt-typography-title-h3',
                'type'     => 'typography',
                'title'    => __( 'Title H3 style', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify the body font properties.', 'redux-framework-demo' ),
                'google'   => true,
                'output' => array('h3'),
                'default'  => array(
            ...
            array(
                'id'       => 'opt-typography-title-h4',
                'type'     => 'typography',
                'title'    => __( 'Title H4 style', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify the body font properties.', 'redux-framework-demo' ),
                'google'   => true,
                'output' => array('h4'),
                'default'  => array(
