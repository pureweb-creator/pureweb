...
?>
<!DOCTYPE html>
<html <?php language_attributes(); ?> <?php if(is_front_page()): echo 'class="overflow-hidden"'; endif; ?>>
<head>
	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-177330585-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-177330585-1');
	</script>
    ...
    <div class="heading d-flex">
        ...
        <div class="contact_info">
            ...
            <span class="contact__mail"><i class="fa fa-envelope"></i> <?php echo $pureweb_redux['email'] ?></span>
				...
				<div class="contact_info pureweb_languages">
	        <ul class="pureweb_languages-list d-flex">
        ...
        <div class="heading d-flex">
            ...
            <div class="contact_info">
                ...
                <span class="contact__mail"><i class="fa fa-envelope"></i> <?php echo $pureweb_redux['email']; ?></span>
						...
						<form class="search form-search mobile-search" role="form" action="<?php get_home_url("/"); ?>" method="get">
							<a href="<?php echo esc_url(get_home_url("/")) ?>" class="logo mobile-logo">
	            	<img src="<?php echo $pureweb_redux['home-logo']['url']; ?>" alt="home logo">
	            </a>
							<input type="text" placeholder="<?php echo pll__("Поиск"); ?>" name="s" value="<?php echo esc_attr(get_search_query()); ?>">
				      <button type="submit" name="button"> <i class="fal fa-search"></i> </button>
...
<header id="hero" class="hero">
    <div class="container">
        <div class="heading d-flex">
            <a href="<?php echo esc_url(get_home_url("/")) ?>" class="logo">
							<?php
							if($pureweb_redux['home-logo']):
								echo '<img src="'.esc_url($pureweb_redux['home-logo']['url']).'" alt="home logo" />';
							else:
								echo bloginfo('name');
							endif;
							?>
            ...
            <div class="contact_info">
                ...
                <span class="contact__mail"><i class="fa fa-envelope"></i> <?php echo $pureweb_redux['email']; ?></span>
						...
						<form class="search mobile-search form-search" role="form" action="<?php get_home_url("/"); ?>" method="get">
							<a href="<?php echo esc_url(get_home_url("/")) ?>" class="logo mobile-logo">
	            	<img src="<?php echo $pureweb_redux['home-logo']['url']; ?>" alt="home logo">
	            </a>
							<input type="text" placeholder="<?php echo pll__("Поиск"); ?>" name="s" value="<?php echo esc_attr(get_search_query()); ?>">
